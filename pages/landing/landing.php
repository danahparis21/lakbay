<?php
// LAKBAY Landing Page - Enhanced Edition with More Interactive Elements
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<nav class="navbar">
  <div class="navbar-inner">
    ...
    <div class="nav-actions">
      <a href="lakbayLogin.php" class="btn-login">Log In</a>
      <a href="lakbaySignup.php" class="btn-signup">Sign Up</a>
    </div>
  </div>
</nav>
...
<section class="hero">
  ...
  <div class="hero-content">
    ...
    <div class="hero-buttons">
      <a href="lakbayLogin.php?redirect=quiz" class="btn-primary" id="findTrailBtn"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"/></svg>Find My Trail</a>
      <a href="#" class="btn-secondary" id="exploreMountainsBtn">Explore Nasugbu Mountains →</a>
    </div>
    <div class="hero-stats">
      <div class="stat-glass"><span class="stat-number">15+</span><span class="stat-label">Mountains</span></div>
      <div class="stat-glass"><span class="stat-number">500+</span><span class="stat-label">Happy Hikers</span></div>
      <div class="stat-glass"><span class="stat-number">24/7</span><span class="stat-label">Safety Support</span></div>
    </div>
  </div>
</section>
...
<section class="section">
  <div class="container">
    ...
    <div class="features-grid">
      <div class="feature-card"><div class="feature-icon"><svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="#100600" stroke-width="1.5"><path d="M4 20L12 4L20 20H4Z"/><circle cx="12" cy="14" r="2"/></svg></div><h3>Trail Discovery</h3><p>Explore detailed information about four stunning mountains in Nasugbu, Batangas.</p></div>
      <div class="feature-card"><div class="feature-icon"><svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="#100600" stroke-width="1.5"><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"/></svg></div><h3>Personalized Quiz</h3><p>Take our trail-matching quiz to find the perfect mountain for your experience level.</p></div>
      <div class="feature-card"><div class="feature-icon"><svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="#100600" stroke-width="1.5"><path d="M12 2L3 6v6c0 5.5 9 10 9 10s9-4.5 9-10V6l-9-4z"/></svg></div><h3>Verified Guides</h3><p>Connect with experienced local guides for a safe and authentic hiking experience.</p></div>
      <div class="feature-card"><div class="feature-icon"><svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="#100600" stroke-width="1.5"><circle cx="12" cy="12" r="10"/><path d="M12 8v4M12 16h.01"/></svg></div><h3>Real-time Updates</h3><p>Get live weather advisories and trail condition updates before your hike.</p></div>
      <div class="feature-card"><div class="feature-icon"><svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="#100600" stroke-width="1.5"><rect x="3" y="4" width="18" height="18" rx="2"/><path d="M16 2v4M8 2v4M3 10h18"/></svg></div><h3>Easy Booking</h3><p>Book guides and manage your hiking schedule all in one seamless platform.</p></div>
    </div>
  </div>
</section>
...
<!-- Testimonials Section - New Element -->
<section class="section">
  <div class="container">
    ...
    <div class="testimonial-grid">
      <div class="testimonial-card"><div class="testimonial-text">"LAKBAY made it so easy to find the right mountain for my skill level. The quiz was spot-on and the guide booking was seamless!"</div><div class="testimonial-author"><div class="author-avatar">MR</div><div class="author-info"><h4>Maria Reyes</h4><p>First-time hiker</p></div></div></div>
      <div class="testimonial-card"><div class="testimonial-text">"The real-time weather advisories saved our group from a sudden storm. Highly recommended for anyone planning a hike in Batangas."</div><div class="testimonial-author"><div class="author-avatar">JT</div><div class="author-info"><h4>James Tan</h4><p>Experienced mountaineer</p></div></div></div>
      <div class="testimonial-card"><div class="testimonial-text">"Booked a guide through LAKBAY and had an incredible experience. Our guide was knowledgeable and made the hike unforgettable."</div><div class="testimonial-author"><div class="author-avatar">CD</div><div class="author-info"><h4>Carmen Diaz</h4><p>Weekend adventurer</p></div></div></div>
    </div>
  </div>
</section>
...
<section class="section" style="background: rgba(108, 122, 108, 0.04);">
  <div class="container">
    ...
    <div class="why-grid">
      <div class="why-card"><div class="feature-icon"><svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="#100600" stroke-width="1.5"><path d="M4 20L12 4L20 20H4Z"/><circle cx="12" cy="14" r="2"/></svg></div><h3>Comprehensive Trail<br>Information</h3><p>Detailed guides including difficulty levels, duration, fees, and environmental protocols for all four mountains.</p></div>
      <div class="why-card"><div class="feature-icon"><svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="#100600" stroke-width="1.5"><path d="M12 2L3 6v6c0 5.5 9 10 9 10s9-4.5 9-10V6l-9-4z"/></svg></div><h3>Safety First<br>Approach</h3><p>Real-time weather updates, hazard warnings, and a verified guide system to keep you protected on the trail.</p></div>
      <div class="why-card"><div class="feature-icon"><svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="#100600" stroke-width="1.5"><rect x="3" y="4" width="18" height="18" rx="2"/><path d="M16 2v4M8 2v4M3 10h18"/></svg></div><h3>Easy Booking<br>System</h3><p>Book guides, manage your hiking schedule, and receive confirmations — all in one seamless platform.</p></div>
      <div class="why-card"><div class="feature-icon"><svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="#100600" stroke-width="1.5"><path d="M12 2L3 6v6c0 5.5 9 10 9 10s9-4.5 9-10V6l-9-4z"/></svg></div><h3>Environmental<br>Stewardship</h3><p>Promoting responsible hiking with Leave No Trace principles to preserve Nasugbu's beauty for future generations.</p></div>
    </div>
  </div>
</section>
...
<section class="section" id="mountains-section">
  <div class="container">
    ...
    <div class="mountains-grid">
      <?php
      $mountains = [
        ['name' => 'Mt. Batulao', 'diff' => 'moderate', 'elev' => '811m', 'time' => '4-5 hrs', 'rating' => 4.8, 'img' => 'https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=600&q=80'],
        ['name' => 'Mt. Apayang', 'diff' => 'hard', 'elev' => '980m', 'time' => '6-7 hrs', 'rating' => 4.9, 'img' => 'https://images.unsplash.com/photo-1519681393784-d120267933ba?w=600&q=80'],
        ['name' => 'Mt. Lantik', 'diff' => 'moderate', 'elev' => '710m', 'time' => '4-5 hrs', 'rating' => 4.7, 'img' => 'https://images.unsplash.com/photo-1501854140801-50d01698950b?w=600&q=80'],
        ['name' => 'Mt. Talamitam', 'diff' => 'easy', 'elev' => '630m', 'time' => '3-4 hrs', 'rating' => 4.6, 'img' => 'https://images.unsplash.com/photo-1464822759023-fed622ff2c3b?w=600&q=80']
      ];
      foreach ($mountains as $m): ?>
      <div class="mtn-card" onclick="window.location.href='explore.php'">
        <div class="mtn-img" style="background-image: url('<?php echo $m['img']; ?>')">
          <span class="mtn-badge badge-<?php echo $m['diff']; ?>"><?php echo ucfirst($m['diff']); ?></span>
        </div>
        <div class="mtn-info">
          <div class="mtn-name"><?php echo $m['name']; ?></div>
          <div class="mtn-meta-icons">
            <div class="meta-item"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8"><path d="M4 20L12 4L20 20H4Z"/><circle cx="12" cy="14" r="1.5"/></svg><span><?php echo $m['elev']; ?></span></div>
            <div class="meta-item"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></svg><span><?php echo $m['time']; ?></span></div>
          </div>
          <div class="rating-wrapper"><div class="rating"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"/></svg><span><?php echo $m['rating']; ?></span></div><div class="view-btn">View Details</div></div>
        </div>
      </div>
      <?php endforeach; ?>
    </div>
...
<section class="section">
  <div class="container">
    <div class="cta-glass"><h2>Find a Local Guide</h2><p style="margin-top: 12px; opacity: 0.9;">Certified local guides who know every trail like the back of their hand</p><div style="margin-top: 32px;"><a href="bookings.php" class="btn-outline-light">Browse Verified Guides →</a><a href="bookings.php" class="btn-outline-light" style="margin-left: 16px;">Book Your Hike Easily</a></div><p style="margin-top: 28px; font-size: 14px; opacity: 0.7;">✓ Verified Guides ✓ Best Rates ✓ 24/7 Support</p></div>
  </div>
</section>
...
<section class="section">
  <div class="container" style="text-align: center;">
    ...
    <p class="section-subtitle">Join thousands of hikers who trust LAKBAY for their mountain adventures</p>
    <div class="hero-buttons" style="justify-content: center;">
      <a href="lakbaySignup.php" class="btn-primary">Sign Up →</a>
...
<footer class="footer">
  <div class="footer-grid">
    <div class="footer-col"><h4>About LAKBAY</h4><p>Your trusted guide to the mountains of Nasugbu, Batangas. We connect adventurers with safe, memorable hiking experiences.</p></div>
    ...
    <div class="footer-col"><h4>Quick Links</h4><p><a href="explore.php">Explore Mountains</a></p><p><a href="quiz.php">Take the Quiz</a></p><p><a href="bookings.php">Book a Guide</a></p></div>
  </div>
  <div class="copyright">© <?php echo date('Y'); ?> LAKBAY — Nasugbu Tourism. All rights reserved.</div>
</footer>

<script>
  document.getElementById('findTrailBtn')?.addEventListener('click', (e) => { e.preventDefault(); window.location.href = 'lakbayLogin.php?redirect=quiz'; });
